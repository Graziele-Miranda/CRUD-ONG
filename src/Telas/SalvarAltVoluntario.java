 ...
 * @author limag
 */
public class SalvarAltVoluntario extends javax.swing.JFrame {

    /**
     * Creates new form SalvarAltVoluntario
     */
    public SalvarAltVoluntario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cpfvol = new javax.swing.JTextField();
        ...
        setTitle("Alterar Dados Voluntário");
        ...
        cpfvol.setEditable(false);
        cpfvol.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        cpfvol.setForeground(new java.awt.Color(84, 88, 113));
        cpfvol.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(73, 81, 129), 1, true));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cpfvol, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cpfvol, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/altvoltela.png"))); // NOI18N
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        AlterarVoluntario alt = new AlterarVoluntario();
        Voluntario a= new Voluntario ();
        //try {
            a.setNome(nome.getText());
            a.setCpf(cpfvol.getText());
            ...
            dao.alterarVoluntario(a);

            JOptionPane.showMessageDialog(null, "Voluntário alterado com sucesso.");
    ...
    public void alterar(String cpf){
        try {
            VoluntarioDAO dao = new VoluntarioDAO();
            List<Voluntario> listVol = dao.ConsVoluntarioCpf(cpf);
            
            for(Voluntario f : listVol){
                
                cpfvol.setText(f.getCpf());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalvarAltVoluntario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalvarAltVoluntario().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField cpfvol;
