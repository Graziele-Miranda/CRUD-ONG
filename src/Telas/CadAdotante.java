 ...
 * @author limag
 */
public class CadAdotante extends javax.swing.JFrame {

    /**
     * Creates new form CadAdotante
     */
    public CadAdotante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 680, 120));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 680, 110));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, 680, 120));
        ...
        getContentPane().add(btCad, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 630, 200, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones/voltar.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 120, 90, 60));
        ...
        getContentPane().add(btVoltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 120, 90, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/cadadotantes.png"))); // NOI18N
        jLabel1.setPreferredSize(new java.awt.Dimension(750, 750));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, 700));
...
cadastrarAdotante();        // TODO add your handling code here:
    ...
    public void cadastrarAdotante () {
        ...
        dao.cadAdotante(a);
         ...
         if(a!=null){
            JOptionPane.showMessageDialog(null, "Adotante cadastrado com sucesso!", "Cadastro OK", 1);
            limpar();
         }
        else{
             
            JOptionPane.showMessageDialog(null, "Já existe um adotante com este CPF!", "Erro de cpf", 0);
            idade.setText("");
            idade.requestFocus();
         }
  ...
  //          JOptionPane.showMessageDialog(null, "O CPF deve ser um inteiro!", "ERRO de ID", 0);
    //        cpf1.setText("");
     ...
     public void sair(){
        int resp = JOptionPane.showConfirmDialog(
                    null,
                    "Deseja sair da página de Cadastro de Adotante?",
                    "Saida",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadAdotante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
